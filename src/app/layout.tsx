...
export const metadata: Metadata = {
  title: "Mvpblocks - Modern UI Component Library",
  description: "Build beautiful UIs faster with Mvpblocks. Comprehensive UI component library with 200+ ready-to-use components for React, Vue, and Angular.",
  keywords: "UI components, React components, Vue components, Angular components, UI library, design system, frontend development",
  metadataBase: new URL("https://mvpblocks.com"),
  alternates: {
    canonical: "https://mvpblocks.com"
  },
  openGraph: {
    title: "Mvpblocks - Modern UI Component Library",
    description: "Build beautiful UIs faster with our comprehensive component library",
    url: "https://mvpblocks.com",
    siteName: "Mvpblocks",
    images: [
      {
        url: "https://images.pexels.com/photos/17345643/pexels-photo-17345643.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Mvpblocks UI component showcase"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Mvpblocks - Modern UI Component Library",
    description: "Build beautiful UIs faster with our comprehensive component library",
    images: ["https://images.pexels.com/photos/17345643/pexels-photo-17345643.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
